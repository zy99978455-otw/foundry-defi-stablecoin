...
contract DSCEngine is ReentrancyGuard {
    ...
    ///////////////////////////
    /**
     * @param tokenCollateralAddress: The ERC20 token address of the collateral you're deposting
    ...
    function mintDsc(uint256 amountDscToMint) public moreThanZero(amountDscToMint) nonReentrant {
        ...
        _revertIfHealthFactorsBroken(msg.sender);
    ...
    function _healthFactor(address user) private view returns(uint256){
        // 1. Get the total value of the collateral in USD
        (uint256 totalDscMinted, uint256 collateralValueInUsd) = _getAccountInformation(user);
        // 2. Adjust the collateral value by the liquidation threshold. This is because we want to make sure the protocol is always overcollateralized.
    ...
    */
     ...
     * @notice: You will get a 10% LIQUIDATION _BONUS for taking the users funds.
